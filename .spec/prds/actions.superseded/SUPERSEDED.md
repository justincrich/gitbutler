...
## Why
This PRD scoped the capability — *a local runner that gates a code change on a pass/fail bound to the head OID* — as a **cryptographic "agent-non-forgeable validation"** system: a signed, agent-unwritable hardened ledger, HMAC→Ed25519, an OS-sandboxed executor, all carried as owed debt.
