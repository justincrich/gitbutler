...
- **v1 signing is symmetric HMAC** (a named accepted residual — a leaked producer secret could forge; Ed25519 + sandboxed executor deferred), chosen to ship the non-fakeability *shape* while being honest about the residual, exactly as governance named R6.
