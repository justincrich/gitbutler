...
### Prior red-hat follow-ups (14 files; triage pending — see REMEDIATE-06B-C)
...
- REMEDIATE-06B-A-reconcile-sprint-bookkeeping-and-ac-ledger-at-head.md — closes F6, F7-partial
- REMEDIATE-06B-B-verify-backend-lossless-roundtrip-and-ct-harness-liveness.md — closes F8, F9
- REMEDIATE-06B-C-triage-14-backlog-follow-up-tasks.md — closes F7
- REMEDIATE-06B-D-add-uc-mgmt-06-capstone-no-bypass-proof-ac.md — closes F2
- REMEDIATE-06B-E-meta-record-execution-order-for-four-unstarted-ui-tasks.md — closes F1, F3, F4, F5
