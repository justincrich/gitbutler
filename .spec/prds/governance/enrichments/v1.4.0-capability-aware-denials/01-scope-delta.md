...
| Changing **which** actions are gated, or the **codes** themselves | OUT (non-goal) | v1.4.0 changes the denial's *payload*, never the gate decision or the code set `{perm.denied, branch.protected, gate.review_required, config.invalid}`. |
