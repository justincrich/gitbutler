...
### UC-RUN-02: mechanism-agnostic clean checkout at head OID _(load-bearing)_
...
### UC-GATE-03: fail-closed + STEER denial _(load-bearing)_
...
### UC-GATE-04: read-only consumer _(load-bearing)_
